...
Uses PyPDF2 for text extraction and Claude for structured parsing.
"""
...
class OEDParser:
    ...
    def _parse_with_llm(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            clean_message = self.client.messages.create(
            ...
            raise ValueError(f"Failed to parse with Claude: {e}")
